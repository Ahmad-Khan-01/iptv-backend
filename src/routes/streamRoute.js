...
router.get(
  "/:id/episode/season",
  streamController.getSeasonOfEpisodeOfStreamByStreamId
);

router.get(
  "/:id/episode/season/series",
  streamController.getSeriesOfSeasonOfEpisodeofStreamByStreamId
);

router.get(
  "/:id/episode/season/series/genre",
  streamController.getGenreOfSeriesOfSeasonOfEpisodeOfStreamByStreamId
);
